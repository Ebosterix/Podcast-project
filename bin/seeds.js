  ...
  const movies = [
    {
      ...
      plot: 'Tom Hanks movie', celebrities: ["Tom Hanks"]
    },

    {
      title: 'One Day', genre: 'Drama',
      plot: 'Anne Hathaway movie',celebrities: ["Anne Hathaway"]
    },

    {
      title: 'Borat', genre: 'Comedy',
      plot: 'Borat movie',celebrities: ["Borat"]
    }, 
